...
public class ListProcessorTester
{
    ...
    public static void getMinTests() {
        ...
        actual = lp.getMin(array2arraylist(new String[]{"lion", "aardvark", "zebra", "cougar", "cheetah"}));
        Testing.assertEquals("boundary case: minimum in second position",
                "aardvark",
                actual);

        actual = lp.getMin(array2arraylist(new String[]{"lion", "zebra", "aardvark", "cougar", "cheetah"}));
        Testing.assertEquals("boundary case: minimum in third position",
                "aardvark",
                actual);

        actual = lp.getMin(array2arraylist(new String[]{"lion", "zebra", "cougar", "aardvark", "cheetah"}));
        Testing.assertEquals("boundary case: minimum in fourth position",
                "aardvark",
                actual);
    ...
    public static void getMinIndexTests() {
        ...
        actual = lp.getMinIndex(array2arraylist(new String[]{"lion", "aardvark", "zebra", "cougar", "cheetah"}));
        Testing.assertEquals("boundary case: minimum in second position",
                1,
                actual);

        actual = lp.getMinIndex(array2arraylist(new String[]{"lion", "zebra", "aardvark", "cougar", "cheetah"}));
        Testing.assertEquals("boundary case: minimum in third position",
                2,
                actual);

        actual = lp.getMinIndex(array2arraylist(new String[]{"lion", "zebra", "cougar", "aardvark", "cheetah"}));
        Testing.assertEquals("boundary case: minimum in fourth position",
                3,
                actual);
        ...
        actual = lp.getMinIndex(array2arraylist
                (new String[]{"antelope", "lion", "zebra", "cougar", "antelope"}));
        Testing.assertEquals("boundary case: minimum in first and last position",
                0,
                actual);
    }
